...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Kakobit Core kakobit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kakobit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kakobit transaction") + "\n" +
              "  kakobit-tx [options] -create [commands]   " + _("Create hex-encoded kakobit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kakobit transaction
