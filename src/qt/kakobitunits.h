...
#ifndef KAKOBIT_QT_KAKOBITUNITS_H
#define KAKOBIT_QT_KAKOBITUNITS_H
...
/** Kakobit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KakobitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KakobitUnits(QObject *parent);

    /** Kakobit units.
      @note Source: https://en.kakobit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KBT,
...
typedef KakobitUnits::Unit KakobitUnit;

#endif // KAKOBIT_QT_KAKOBITUNITS_H
