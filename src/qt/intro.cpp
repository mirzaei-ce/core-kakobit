...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/kakobit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kakobit Core"),
     ...
     * override -datadir in the kakobit.conf file in the default data directory
     * (to be consistent with kakobitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
