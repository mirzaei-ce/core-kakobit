...
#ifndef KAKOBIT_TEST_SCRIPTNUM10_H
#define KAKOBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kakobit Core 0.10.0, for cross-comparison.
 */
public:
