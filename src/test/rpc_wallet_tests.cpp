...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CKakobitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CKakobitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CKakobitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CKakobitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CKakobitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKakobitAddress(arr[0].get_str()).Get() == demoAddress.Get());
