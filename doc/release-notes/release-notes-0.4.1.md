Kakobit version 0.4.1 is now available for download at:
http://sourceforge.net/projects/kakobit/files/Kakobit/kakobit-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxkakobit or kakobitd the wallet will be rewritten, Kakobit will
...
wxKakobit: new address visible on main window
