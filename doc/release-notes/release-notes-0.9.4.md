Kakobit Core version 0.9.4 is now available from:

  https://kakobit.org/bin/0.9.4/
...
this update is incompatible with the Kakobit system and could lead to consensus
forks.

Kakobit Core released binaries from https://kakobit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kakobit/+archive/ubuntu/kakobit
- A third-party or self-compiled Kakobit Core

upgrade to Kakobit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
