Kakobit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kakobit/files/Kakobit/kakobit-0.5.4/
...
http://gitorious.org/kakobit/kakobitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Kakobit-Qt notifications under Growl 1.3.
Increase required age of Kakobit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKakobit properly when installing Kakobit-Qt over it. (Windows)
