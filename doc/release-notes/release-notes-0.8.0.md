Kakobit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kakobit/files/Kakobit/kakobit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kakobit
...
New/changed settings (command-line or kakobit.conf file)
--------------------------------------------------------
