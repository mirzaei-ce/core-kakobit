...
This document provides guidelines for internationalization of the Kakobit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kakobit_en.ts` remains unchanged.
