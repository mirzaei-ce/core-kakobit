...
unlocked to sign the Kakobit-Qt.app bundle.
...
allowing somebody to distribute a Kakobit-Qt.app or kakobit-qt-setup.exe with a valid
...
that the kakobit-qt.exe file inside the installer had not been tampered with.
